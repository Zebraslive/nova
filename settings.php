        ...
        <div class="flex-1 p-8 settings-content">
            <div class="max-w-4xl mx-auto">
                <div class="mb-8">
                    ...
                    <p class="text-slate-400 text-lg">Customize your Nova experience</p>
                </div>
                ...
                <div class="bg-gradient-to-r from-purple-500/10 via-purple-500/20 to-purple-500/10 border border-purple-500/20 p-6 rounded-xl mb-8 relative overflow-hidden">
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-slate-300">Nova's settings page is currently under active development. More customization options will be added soon.</p>
                        </div>
                    </div>
                </div>
                ...
                <div x-show="activeSection === 'appearance'" class="animate-fade-in space-y-8">
                    <div class="mb-6">
                        ...
                        <p class="text-slate-400">Customize how Nova looks and feels</p>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center justify-between p-4 bg-slate-800/50 rounded-lg">
                            <div class="space-y-1">
                                ...
                                <p class="text-sm text-slate-400">Toggle the animated particle effect in the background of Nova</p>
                            </div>
                            <button 
